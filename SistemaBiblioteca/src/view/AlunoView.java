...
public class AlunoView extends JPanel {
    ...
    public AlunoView() {
        ...
        add(createHeader("GERENCIAR ALUNOS", "Cadastro, edição e remoção de alunos"), BorderLayout.NORTH);
        ...
        addField(form, gbc, "Nome",      campoNome,      0, 0);
        addField(form, gbc, "Matrícula", campoMatricula, 1, 0);
        addField(form, gbc, "Endereço",  campoEndereco,  2, 0);
    ...
    private void addSeparator(JPanel p) {
        // decorative top border via background panel
    }
}