...
public class ReservaView extends JPanel {
    ...
    public JButton btnReservar = createButton("Reservar",           true);
    public JButton btnCancelar = createButton("Cancelar selecionada", false);

    public ReservaView() {
        setLayout(new BorderLayout(0, 0));
        setBackground(BG_DARK);

        add(createHeader("RESERVAS", "Gerencie as reservas de livros do acervo"), BorderLayout.NORTH);

        String[] colunas = {"Usuário", "Livro", "Solicitação", "Expiração", "Status"};
        ...
        tabela.getColumnModel().getColumn(4).setCellRenderer(
            new javax.swing.table.DefaultTableCellRenderer() {
                @Override public Component getTableCellRendererComponent(JTable t, Object val,
                    ...
                    setForeground(s.contains("Expirada") || s.contains("Cancelada") ? new Color(220, 80, 80)
                                : s.contains("Ativa") ? new Color(100, 200, 120)
                                : ACCENT);
